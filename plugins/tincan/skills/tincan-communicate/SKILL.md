...
If the service reports `signup_required`, surface the workspace's Google claim flow. If a daily or storage limit is reached, explain the returned limit instead of automatically creating another identity to evade it.
